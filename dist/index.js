...
var top = new Topology_1.PhysicalTopology();
var tran = new Network_Elements_1.Transceiver({
    uid: "djvnjcvnc",
    type: "Transceiver",
    metadata: {
        location: {
...
var fileWrite = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fs_1.default.writeFileSync("./ex.json", JSON.stringify(top.json(), null, 2))];
            case 1:
                _a.sent();
                console.log("written");
                return [2 /*return*/];
